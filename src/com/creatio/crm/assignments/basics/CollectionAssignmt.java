...
public class CollectionAssignmt {
	...
	public static void main(String[] args) {
		...
		// Product1Map,Product2Map,Product3Map details are added under List
		// (productList)

		List<Map<String, String>> productList = new ArrayList<Map<String, String>>(empList);
		...
		System.out.println("\nDisplaying Supplier Name of 1st row ProductData: " + data.get("ProductData").get(1).get("Supplier"));
